...
```console
composer require lungdsuomozhui/livewire-bootstrap-modal
```
...
Require `../../vendor/lungdsuomozhui/livewire-bootstrap-modal/resources/js/modals` in your app javascript file:

```javascript
import('@popperjs/core');
import '../../node_modules/bootstrap/dist/js/bootstrap.bundle.min.js';
import '../../vendor/lungdsuomozhui/livewire-bootstrap-modal/resources/js/modals.js';
```
